...
document.addEventListener('DOMContentLoaded', event => {
	...
	readData.addEventListener('click', async() => {
		...
		cardAuth = new Uint8Array([0x6F, 0x06, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0xFF, 0x88, 0x00, content, 0x60, 0x00])
		console.log(cardAuth)
		dataRead = new Uint8Array([0x6F, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xB0, 0x00, content, 0x10])
